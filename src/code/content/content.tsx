...
function Content() {
  ...
  return (
    <>
      <section className="w-[28rem] flex justify-center items-center pt-20" style={{ backgroundImage: `url(${backgroundLow})`, backgroundSize: '100%', backgroundPosition: "center" }} >
      ...
      <section className="w-[28rem] flex flex-col items-center" style={{ backgroundImage: `url(${backgroundImageVisible? backgroundLow : ""})`, backgroundSize: '100%', backgroundPosition: "center" }} >
        <div className='w-[240px] flex justify-center items-center flex-col gap-y-7'>
          <div className='flex justify-center items-center flex-col scroll-animation invisible-animation'>
            ...
            <p className='text-[15px] custom-font-cinzel mb-3'>5 Zulkaedah 1446H</p>
            <div className='w-[13rem] scroll-animation invisible-animation'>
              <img src={wedLine}/>
            </div>
          </div>
      ...
      <section className="w-[28rem] flex flex-col items-center" style={{ backgroundImage: `url(${backgroundImageVisible? backgroundLow : ""})`, backgroundSize: '100%', backgroundPosition: "center" }} >
        <div className='w-[240px] flex justify-center items-center flex-col gap-y-7 pt-3'>
          <div className='flex justify-center items-center flex-col scroll-animation invisible-animation'>
          ...
          <div className='w-[13rem] h-[200px] scroll-animation invisible-animation'>
              <img src={wedLine}/>
          </div>
        </div>
      </section>
